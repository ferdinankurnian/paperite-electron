<template>
    <!-- Dark Overlay -->
    <div id="darkOverlay" class="fixed inset-0 bg-black opacity-50 hidden z-40"></div>
    ...
    <div id="sidebar"
        ...
        <ul class="m-4 space-y-2">
            ...
            <li>
              <div class="border-t border-gray-300 mx-4">
              </div>
            </li>
            <li>
                <a href="#"
                    class="block flex items-center gap-2 rounded-md px-4 py-2 text-red-500 hover:bg-gray-200 hover:text-red-700"><span
